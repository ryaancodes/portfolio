...
/**
 * Hand-rolled brand icons.
 *
 * lucide-react does not ship every brand/social icon, so the three
 * used in this portfolio (GitHub, LinkedIn, Instagram) are defined
 * here as simple inline SVGs that inherit `currentColor`.
 */
