...
export function Contact() {
  ...
  const [status, setStatus] = useState<
    'idle' | 'submitting' | 'success' | 'redirected' | 'error'
  >('idle');
    ...
    <section id="contact" className="py-20 lg:py-[120px]">
      <div className="section-container">
        ...
        <motion.div
          ...
          className="mb-14"
        >
          <span className="mb-4 block font-mono text-[13px] text-accent">
            06 · Contact
          </span>
          ...
          <p className="max-w-[52ch] text-[17px] leading-[1.7] text-muted">
            I&apos;m currently looking for software engineering internships. If you&apos;re hiring or have an opportunity that fits my background,
